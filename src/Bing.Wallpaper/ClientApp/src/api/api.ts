 ...
 * @export
 */
export const BingImagesApiAxiosParamCreator = function (
    ...
    return {
         ...
         */
        apiv10BingImagesCollectImages: async (
            bingImageServiceGetRequestModel?: BingImageServiceGetRequestModel,
            options: any = {},
        ): Promise<RequestArgs> => {
...
export const BingImagesApiFp = function (configuration?: Configuration) {
    const localVarAxiosParamCreator =
        BingImagesApiAxiosParamCreator(configuration);
    return {
        /**
         *
         * @param {BingImageServiceGetRequestModel} [bingImageServiceGetRequestModel]
         ...
         * @throws {RequiredError}
         */
        async apiv10BingImagesCollectImages(
            bingImageServiceGetRequestModel?: BingImageServiceGetRequestModel,
            options?: any,
        ): Promise<
            (
                axios?: AxiosInstance,
                basePath?: string,
            ) => AxiosPromise<ObjectApiResponseModel>
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiv10BingImagesCollectImages(
                    bingImageServiceGetRequestModel,
                    options,
                );
 ...
 * @export
 */
export const BingImagesApiFactory = function (
    configuration?: Configuration,
    basePath?: string,
    axios?: AxiosInstance,
) {
...
export class BingImagesApi extends BaseAPI {
     ...
     */
    public apiv10BingImagesCollectImages(
        requestParameters: BingImagesApiApiv10BingImagesCollectImagesRequest = {},
        options?: any,
    ) {
        return BingImagesApiFp(this.configuration)
            .apiv10BingImagesCollectImages(
                requestParameters.bingImageServiceGetRequestModel,
                options,
            )
...
export const FilesApiAxiosParamCreator = function (
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiv10FilesGetFileByFileName: async (
            fileName: string,
            type?: string,
            options: any = {},
        ): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/Files/{fileName}`.replace(
                `{${'fileName'}}`,
...
export const FilesApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiv10FilesGetFileByFileName(
            fileName: string,
            type?: string,
            options?: any,
        ): Promise<
        ...
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiv10FilesGetFileByFileName(
                    fileName,
                    type,
                    options,
                );
        ...
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiv10FilesGetFileById(
                    id,
                    type,
                    options,
                );
...
export const FilesApiFactory = function (
    ...
    return {
        ...
        apiv10FilesGetFileByFileName(
            ...
            return localVarFp
                .apiv10FilesGetFileByFileName(fileName, type, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        apiv10FilesGetFileById(
            id: string,
            type?: string,
            options?: any,
        ): AxiosPromise<any> {
            return localVarFp
                .apiv10FilesGetFileById(id, type, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class FilesApi extends BaseAPI {
     ...
     * @memberof FilesApi
     */
    public apiv10FilesGetFileByFileName(
        requestParameters: FilesApiApiv10FilesGetFileByFileNameRequest,
        options?: any,
    ) {
     ...
     * @memberof FilesApi
     */
    public apiv10FilesGetFileById(
        requestParameters: FilesApiApiv10FilesGetFileByIdRequest,
        options?: any,
    ) {
        return FilesApiFp(this.configuration)
            .apiv10FilesGetFileById(
    ...
    return {
        ...
        async apiv10ImagesGetAll(
            ...
            (
                axios?: AxiosInstance,
                basePath?: string,
            ) => AxiosPromise<ImageItemModelPagedModelApiResponseModel>
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiv10ImagesGetAll(
                    page,
                    take,
                    options,
                );
...
export const ImagesApiFactory = function (
    ...
    return {
        ...
        apiv10ImagesGetAll(
            ...
            return localVarFp
                .apiv10ImagesGetAll(page, take, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class ImagesApi extends BaseAPI {
     ...
     * @memberof ImagesApi
     */
    public apiv10ImagesGetAll(
        requestParameters: ImagesApiApiv10ImagesGetAllRequest = {},
        options?: any,
    ) {
    ...
    return {
        ...
        async apiv10LogsGetAll(
            ...
            (
                axios?: AxiosInstance,
                basePath?: string,
            ) => AxiosPromise<LogModelPagedModelApiResponseModel>
        > {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.apiv10LogsGetAll(
                    page,
                    take,
                    level,
                    keyword,
...
export const LogsApiFactory = function (
    ...
    return {
        ...
        apiv10LogsGetAll(
            ...
            return localVarFp
                .apiv10LogsGetAll(page, take, level, keyword, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class LogsApi extends BaseAPI {
     ...
     * @memberof LogsApi
     */
    public apiv10LogsGetAll(
        requestParameters: LogsApiApiv10LogsGetAllRequest = {},
        options?: any,
    ) {
