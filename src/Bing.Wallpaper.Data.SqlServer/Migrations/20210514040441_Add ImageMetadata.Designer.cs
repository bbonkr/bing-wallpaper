...
namespace Bing.Wallpaper.Data.SqlServer.Migrations
{
    ...
    [Migration("20210514040441_Add ImageMetadata")]
            ...
            modelBuilder.Entity("Bing.Wallpaper.Entities.AppLog", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Logged")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 5, 14, 4, 4, 40, 698, DateTimeKind.Unspecified).AddTicks(1962), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasComment("작성시각");
